    ...
    public partial class InitialDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageParameter", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackageParameter_Package_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Package",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageParameter_TestParameter_TestParameterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageParameter_PackageId",
                table: "PackageParameter",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageParameter_TestParameterId",
                table: "PackageParameter",
